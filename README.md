# Supplementary material — DarkWrt (MIST 2026)
...
This repository contains **documentation only**. It holds no firmware image, no
implanted functions, no build configuration, and no code that implements hidden
functionality. Key implementation details are deliberately withheld here as they are
in the manuscript.
